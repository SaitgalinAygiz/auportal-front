...
import {transformWorkSchedule} from 'utils'
                    ...
                    <>
                        <div className="b1c1">
                            ...
                            <div className="rating-stars">
                                ...
                                <a className="love_add" href="">В избранное</a>
                                <a className="share" href="">Поделиться</a>
                            </div>
                        </div>
                            ...
                            <div className="b1c5_row">
                                <div className="b1c5_item">
                                    <div className="b1c5_item_cont">
                                        ...
                                        <a className="b1c5_item_cont_tel" href="tel:+7 347 123 45 56">{response.contacts.phoneNumber}</a>
                                        <a className="b1c5_item_cont_site" href="https://мфпц.рф" target="_blank">{response.contacts.website}</a>
